...
具体的指令精调代码可以参考[scripts/run_clm_ft_with_peft.py](https://github.com/ymcui/Chinese-LLaMA-Alpaca/blob/main/scripts/run_clm_ft_with_peft.py)，使用方式见[指令精调脚本](https://github.com/ymcui/Chinese-LLaMA-Alpaca/wiki/指令精调脚本)。
